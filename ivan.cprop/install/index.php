...
class ivan_cprop extends CModule
{
    var $MODULE_ID  = 'ivan.cprop';
    ...
    function __construct()
    {
        ...
        $this->MODULE_ID = 'ivan.cprop';
        $this->MODULE_VERSION = $arModuleVersion['VERSION'];
        $this->MODULE_VERSION_DATE = $arModuleVersion['VERSION_DATE'];
        $this->MODULE_NAME = Loc::getMessage('IEX_CPROP_MODULE_NAME_EDITOR');
    ...
    {
        $classHandler = 'CIBlockPropertyCPropAndEditor';
